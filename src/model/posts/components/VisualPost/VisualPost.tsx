  ...
  <Link href={href} className={`flex flex-col`}>
    <figure>
      <div className={`relative`}>
        ...
        >
          <figcaption className="font-primary font-bold text-inverse text-2xl lg:text-3xl hover:underline decoration-3 text-center max-w-xl mb-4 sm:mb-4">
            {isDraft ? "🚧 " : null}
            {title}
          </figcaption>
          ...
          {/* <p
            className={`${typography.variants.textBody} text-sm sm:text-base mt-2 sm:mt-3 font-bold text-inverse text-center max-w-xl`}
          >
            {excerpt}
          </p> */}
          <figcaption
            className={`${typography.variants.secondaryTitle} ${palette.text.inverse} text-center text-sm sm:block self-end mt-4 pr-2 sm:pr-0`}
          >
