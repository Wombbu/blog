...
export function youtubeEmbedPlugin(md: MarkdownIt) {
  ...
  md.renderer.rules.text = (tokens, idx, _options, _env, self) => {
    ...
    if (regex.test(text)) {
      ...
      return `
      <figure>
<iframe width="1422" height="auto" src="https://www.youtube-nocookie.com/embed/${videoId}?autoplay=1&loop=1&playsinline=1&mute=1&showinfo=0&controls=0&disablekb=1&fs=0&color=white&hl=fi&iv_load_policy=3&playlist=${videoId}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="max-width: 1422px; max-height: 800px;"></iframe>
